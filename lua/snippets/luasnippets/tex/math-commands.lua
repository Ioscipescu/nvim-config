...
local auto_backslash_snippet = require("snippets.luasnippets.tex.utils.scaffolding").auto_backslash_snippet
local symbol_snippet = require("snippets.luasnippets.tex.utils.scaffolding").symbol_snippet
local single_command_snippet = require("snippets.luasnippets.tex.utils.scaffolding").single_command_snippet
local postfix_snippet = require("snippets.luasnippets.tex.utils.scaffolding").postfix_snippet
local get_visual = require("snippets.luasnippets.tex.utils.scaffolding").get_visual
...
for _, v in ipairs(auto_backslash_specs) do
  table.insert(
    ...
    auto_backslash_snippet({ trig = v }, { condition = tex.in_math, show_condition = tex.in_math })
  )
end
